<template>
   <div class="outCarint margin45">
      ...
      <p>
         ...
         <span style="margin-left:10px;color:var(--primary)">验证成功！请确认家长信息是否正确</span>
      </p>
            ...
            <div class="content">
               <div class="login-box">
                  ...
                  <div class="login-box-div">
                     ...
                     <input class="flexF" type="text" name="username" id="phone" placeholder="民族" :value="name" maxlength="11">
                  </div>
                  <div class="login-box-div">
                     <span class="flexF">出生日期</span>
                     <input id="verify" type="text" class="infos flexF" name="yanz" placeholder="出生日期" maxlength="4" />
                  </div>
                  <div class="login-box-div">
                  ...
                  <div class="login-box-div">
                     ...
                     <input id="verify" type="text" class="infos flexF" name="yanz" placeholder="身份证号" maxlength="4" />
                  </div>
                  <div class="login-box-div">
                     <span class="flexF">身份证有效期</span>
                     <input id="verify" type="text" class="infos flexF" name="yanz" placeholder="身份证有效期" maxlength="4" />
                  </div>
               </div>
            </div>
         </div>
