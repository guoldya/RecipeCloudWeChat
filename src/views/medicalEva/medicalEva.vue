                    ...
                    <div>
                        <div class="star">
                            <div style="width: 14%;height: 14%">
                                <img src="@/assets/images/head1.png" alt="" style="width: 100%;height: 100%">
                            </div>
                            <div>
                                <p>
                                ...
                                <div>
                                    <img class="starImg" v-for="(star,index) in stars" :src="star.src" v-on:click="rating(index)" alt="星星图片" :key="index" />
                                </div>
                                <span>请选择评分</span>
                            </div>
                        </div>
                        <p class="partLine"></p>
                        <div>
                            <textarea name="" id="" v-model="comment" cols="49" maxlength="50" rows="5" placeholder="服务满足你的期待吗？请大胆说出它的优点与美中不足的地方吧！"></textarea>
...
let appbizOnlineServiceRecordcomment = "/api/hos/bizOnlineServiceRecord/comment";
