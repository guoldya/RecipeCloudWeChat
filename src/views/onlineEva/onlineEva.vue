            ...
            <div>
                <div class="card  ">
                    <div class="cardText">
                        ...
                        <div class="listData">
                            <span>姓名：
                                <span class="mu-secondary-text-color">帆帆帆帆</span>
                            </span>
                        </div>
                        <div class="listData">
                            <span>年龄：
                                <span class="mu-secondary-text-color">33</span>
                            </span>
                            <span style="width: 50%">性别：
                                <span class="mu-secondary-text-color">刚刚</span>
                            </span>
                        </div>
                    </div>
                </div>
...
<style   scoped>
@import "../medicalEva/medicalEva.css";
.onlineEva .info {
  height: 68px;
  font-size: 32px;
}
