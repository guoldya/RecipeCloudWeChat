<template>
   <div class="workdoctor">
      ...
      <div :class="{'outCarint':true,'margin45':isWeixin,'margin7':!isWeixin}">
         <div class="workdoctorserach" style="text-align: center; ">
            <input v-model="value" placeholder="搜索查看医生排班信息" class="oc_val" @input="loadMorelist(value)">
         </div>
         <md-cell-item v-for="(item,index) in test3" @click="workdotorinfo(item.name)" :key="index+'aa'" :title="item.name" :brief="item.good" arrow>
