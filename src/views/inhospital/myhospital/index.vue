         ...
         <div v-if="cordInfoData&&cordInfoData.length!=0" v-show="!loadingtrue">
            <div class="flatCard outCarint " v-for="(item,i) in cordInfoData" :key="i" v-show="!loadingtrue">
               <md-field>
                  ...
                  <md-detail-item title="住院次数" :content=item.recordCount></md-detail-item>
               ...
               <div class="outCarintcontent">
                  <div class="flatCard">
                     <md-field>
                        ...
                        <md-cell-item title="历次住院费用" arrow @click="hospitalization" />
                     </md-field>
                  </div>
               </div>
            </div>
...
export default {
   ...
   methods: {
      ...
      cordInfo() {
         this.$axios.put(cord_info_url, { cardNo: this.$store.state.cardNo }, {
         }).then(res => {
