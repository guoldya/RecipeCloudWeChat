...
let appbdHospitalOrgreadselectHospital = "/api/hos/bdHospitalOrg/read/selectHospital";
let appbizPatientRegisterisExitsProject = "/api/hos/bizPatientRegister/isExitsProject";
